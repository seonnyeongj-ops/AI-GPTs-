...
# ==========================================
app = Flask(__name__)
app.secret_key = 'secret_key_1234'  # 세션 암호화 키 (변경 가능)
ACCESS_PASSWORD = "team2026"        # 🔐 접속 비밀번호
...
<body>
    ...
    <div class="login-box">
        ...
        <form method="POST" action="/login">
            ...
            <button type="submit" class="btn btn-primary" style="width:100%; margin-top:15px; padding:12px;">로그인</button>
        </form>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="text-align: right;">
                <button class="btn btn-copy" onclick="copyText('p{{ loop.index }}')">프롬프트 복사</button>
                <a href="{{ tool.link }}" target="_blank" class="btn btn-primary">GPT 실행하기 👉</a>
            </div>
        </div>
        {% endfor %}
    </div>
...
def login():
    if request.form.get('password') == ACCESS_PASSWORD:
        ...
        return redirect('/')
    return render_template_string(HTML_TEMPLATE, error="비밀번호가 틀렸습니다.", tools=gpt_tools)
...
if __name__ == '__main__':
    print("----------------------------------------------------------------")
    print("👇 아래 나오는 긴 주소를 클릭하세요 (이게 진짜 접속 주소입니다!)")
    # 5000번 포트를 외부로 열어주는 마법의 코드
